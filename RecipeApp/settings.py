...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'recipe.context_processors.ContextData',  #use context_proccessor
                'recipe.context_processors.ContactUs', #use context_proccessor
                'recipe.context_processors.NewsLetter', #use context_proccessor
            ],
        },
    },
]
